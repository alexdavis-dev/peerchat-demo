...
import (
	...
	peerchat "github.com/alex-golang/peer-calls/peerchat"
...
func main() {
	...
	p2phost := peerchat.NewP2P()
	logrus.Infoln("Completed P2P Setup:", p2phost)
	...
	logrus.Infoln("Connected to Service Peers:", *discovery)

	// Join the chat room
	chatapp, _ := peerchat.JoinChatRoom(p2phost, *username, *chatroom)
